...
std::map<std::string, double> frequencies = {
    ...
    {"Eb1", 38.89},   {"E1", 41.20},    {"F1", 43.65},    {"F#1", 46.25},
    {"Gb1", 46.25},   {"G1", 48.99},    {"G#1", 51.91},   {"Ab1", 51.91},
    {"A1", 55.00},    {"A#1", 58.27},   {"Bb1", 58.27},   {"B1", 61.74},

    {"C2", 65.41},    {"C#2", 69.30},   {"D2", 73.42},    {"D#2", 77.78},
    {"Eb2", 77.78},   {"E2", 82.41},    {"F2", 87.31},    {"F#2", 92.50},
    {"Gb2", 92.50},   {"G2", 97.99},    {"G#2", 103.83},  {"Ab2", 103.83},
    ...
    {"Eb4", 311.13},  {"E4", 329.63},   {"F4", 349.23},   {"F#4", 369.99},
    {"Gb4", 369.99},  {"G4", 392.00},   {"G#4", 415.30},  {"Ab4", 415.30},
    {"A4", 440.00},   {"A#4", 466.16},  {"Bb4", 466.16},  {"B4", 493.88},

    {"C5", 523.25},   {"C#5", 554.37},  {"D5", 587.33},   {"D#5", 622.25},
    {"Eb5", 622.25},  {"E5", 659.26},   {"F5", 698.46},   {"F#5", 739.99},
    {"Gb5", 739.99},  {"G5", 783.99},   {"G#5", 830.61},  {"Ab5", 830.61},
    {"A5", 880.00},   {"A#5", 932.33},  {"Bb5", 932.33},  {"B5", 987.77},

    {"C6", 1046.50},  {"C#6", 1108.73}, {"D6", 1174.66},  {"D#6", 1244.51},
    {"Eb6", 1244.51}, {"E6", 1318.51},  {"F6", 1396.91},  {"F#6", 1479.98},
    {"Gb6", 1479.98}, {"G6", 1567.98},  {"G#6", 1661.22}, {"Ab6", 1661.22},
